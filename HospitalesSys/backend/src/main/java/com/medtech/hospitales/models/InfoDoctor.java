...
/**
 * Entidad que representa la información profesional de un doctor,
 * incluyendo fotografía, número de colegiado, usuario, teléfonos y especialidades asociadas.
 */
@Entity
...
public class InfoDoctor {
    ...
    /**
     * Usuario asociado al perfil del doctor.
     */
    ...
    public List<TelefonoDoctor> getTelefonos() { return telefonos; }
    public void setTelefonos(List<TelefonoDoctor> telefonos) { this.telefonos = telefonos; }

    public List<EspecialidadDoctor> getEspecialidades() { return especialidades; }
    public void setEspecialidades(List<EspecialidadDoctor> especialidades) { this.especialidades = especialidades; }
}
